...
var playerRunningImage2, playerJumpingImage2, playerStandingImage;
...
playerStandingImage= loadImage("pictures2/stanging01.PNG");
playerRunningImage2= loadAnimation("pictures2/running01.PNG","pictures2/running02.PNG","pictures2/running03.PNG","pictures2/running04.PNG","pictures2/running05.PNG");
playerJumpingImage2= loadAnimation("pictures2/jumping01.PNG","pictures2/jumping02.PNG","pictures2/jumping03.PNG","pictures2/jumping04.PNG","pictures2/jumping05.PNG");
...
coin27= new Coin(1000,50,10,10);
  ...
  player.addAnimation("playerRunningImage2",playerRunningImage2);
  player.addAnimation("playerJumpingImage2",playerJumpingImage2);
  player.addImage("playerStandingImage",playerStanding);
  player.addImage("playerStandingImage2",playerStandingImage);
  player.debug= true;
}
...
if(keyIsDown(RIGHT_ARROW)){
  player.velocityX=4;
  player.changeAnimation("playerRunningImage",playerRunningImage);
...
if(keyIsDown(LEFT_ARROW)){
  player.velocityX=-4;
  player.changeAnimation("playerRunningImage2",playerRunningImage2);
